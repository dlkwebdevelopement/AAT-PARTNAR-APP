...
const CarRegForm_screen = ({ navigation }) => {
  ...
  const handleSubmit = () => {
    ...
    if (minPrice !== null && kmVal < minPrice) {
      Toast.show({
        ...
        text2: `Minimum allowed for Car is ₹${minPrice}/km`,
      });
      return;
    }
    if (maxPrice !== null && kmVal > maxPrice) {
      Toast.show({
        ...
        text2: `Maximum allowed for Car is ₹${maxPrice}/km`,
      });
      return;
    }
  ...
  const handleConfirmPayment = async () => {
    ...
    try {
      ...
      Toast.show({
        type: "error",
        text1: error.response?.data?.message || "Failed to initiate payment.",
      });
    } finally {
      setLoading(false);
    }
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.input_field_container}>
            ...
            <Dropdown
              ...
              onSelect={(item) => setVehicleType(item.value)}
            />
          </View>
      ...
      >
        <View style={styles.modal_overlay}>
          <View style={styles.modal_box}>
            ...
            <Text style={styles.modal_subtitle}>Car Registration Fee</Text>
