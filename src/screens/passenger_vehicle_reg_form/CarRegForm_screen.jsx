...
const CarRegForm_screen = ({ navigation }) => {
 ...
 const convertToBase64 = async (file) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const res = await AxiosService.post("vendor/createCar", payload);
  ...
  console.log("vendorId", vehicleInsurance);
  ...
  />
          ...
          <View style={styles.CheakBoxsection}>
            <CheckboxWithLabel
              ...
              customStyles={styles.customCheckbox}
            />
          </View>
          {/* button */}
...
export default CarRegForm_screen;
