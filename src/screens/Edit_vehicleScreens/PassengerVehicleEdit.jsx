...
const PassengerVehicleEdit = ({ route }) => {
            ...
            <View style={styles.vehicle_details_main_sec}>
              ...
              <View style={styles.vehicle_details_sec}>
                <View style={styles.vehicle_details_sec}>
                  ...
                  {/* vendor Aadhar details */}
                  <View
                    style={[styles.input_container, styles.image_container]}
                  >
                    <Text style={styles.label}>Vendor Aadhar card</Text>
                    <Image
...
export default PassengerVehicleEdit;
...
const styles = StyleSheet.create({
  ...
  image_and_document_edit_container: {},
