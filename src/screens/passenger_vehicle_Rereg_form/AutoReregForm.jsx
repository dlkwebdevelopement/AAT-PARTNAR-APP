    ...
    const handleSubmit = async () => {
        ...
        try {
          ...
          const res = await AxiosService.post(
            `vendor/editAuto/${vendorId}/${vehicleId}`,
            formData,
            {
              headers: {
          ...
          if (res.status === 201) {
            ...
            Toast.show({
              type: "success",
              text1: "Auto update successful!",
              text2: "Auto has been updated successfully.",
            });
        setTimeout(() => {
            navigation.goBack();
        }, 2000);
        ...
        <View style={styles.content_container}>
          <ScrollView showsVerticalScrollIndicator={false}>
            ...
            <View style={styles.form_heading_container}>
              ...
              />
              {/* form heading text */}
              <Text style={styles.form_heading_txt}>Auto Registartion </Text>
            </View>
            {/* heading text */}
