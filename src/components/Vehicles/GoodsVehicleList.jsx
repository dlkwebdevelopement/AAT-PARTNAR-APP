...
import { goods_vehicle_data } from "../../Data/GoodsVehicleData";
import {
        ...
        <>
          {vehicleData.length === 0 && (
            <View style={styles.no_data_main_container}>
              {/* bell image */}
              <Image
                source={require("../../assets/Images/no-truck-list.jpg")}
                style={styles.img}
              />
              {/* main text */}
              <Text style={styles.main_txt}>No Vehicles Available</Text>
              <Text style={styles.sub_txt}>
                It looks like you haven’t added any vehicles yet. Click the add
                vehicle button to add a new vehicle!
              </Text>
            </View>
          )}
          {vehicleData.length !== 0 && (
            <View style={styles.filter_main_container}>
              ...
              {showButton && (
                <>
                  ...
                  <TouchableOpacity
                    style={[styles.filter_btn_container, styles.filter_btn_tx]} // You can customize the style if needed
          ...
          <View style={{ paddingTop: 10, paddingBottom: 230 }}>
              ...
              <FlatList
                ...
                renderItem={({ item, index }) => {
                  let imageSrc;
                  if (item.goodsType === "Small") {
                    imageSrc = smallTruckImg;
                  } else if (item.goodsType === "Medium") {
                    imageSrc = mediumTruckImg;
                  } else if (item.goodsType === "Large") {
                    imageSrc = largeTruckImg;
                  } else if (item.goodsType === "XL") {
                    imageSrc = XLTruckImg;
                  }
                  return (
